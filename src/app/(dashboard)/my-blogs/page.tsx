...
const MyBlogPage = () => {
  ...
  const fetchMyBlogs = async (search = searchQuery, currentPage = page) => {
    try {
      setLoadingMain(true);
      ...
      const res = await GetMyBlogs(params);
  ...
  const handleDialogSuccess = async () => {
    ...
    await fetchMyBlogs(searchQuery, page);
  };
